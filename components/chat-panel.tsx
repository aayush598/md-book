...
export default function ChatPanel({ question, answer, source, bookName, onClose }: ChatPanelProps) {
  const prompt = buildStudyPrompt({ question, answer, source, bookName });
  ...
  return (
    <div className="flex w-full min-w-0 min-h-0 flex-col overflow-hidden" style={{ height: "100%", background: "var(--bg-page)", borderLeft: "1px solid var(--border-subtle)" }}>
      {/* Header */}
